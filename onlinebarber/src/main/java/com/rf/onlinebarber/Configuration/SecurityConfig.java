...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests((a) ->
                a.requestMatchers(AntPathRequestMatcher.antMatcher("/api/v1/shop/delete/{id}")).authenticated().
                        ...
                        requestMatchers(AntPathRequestMatcher.antMatcher("/api/v1/smodel/add/{id}")).authenticated().requestMatchers(AntPathRequestMatcher.antMatcher("/api/v1/smodel/delete/{id}")).authenticated().
